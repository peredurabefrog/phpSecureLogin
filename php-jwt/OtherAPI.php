<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        $messageResponse = array("status" => 67, "msg" => "This is the otherAPI response", "userId"=>$messageRequest['userId'], "email"=>$messageRequest['email'],"extraTag"=>"extraTag value","buttonPressTimeStamp"=>$messageRequest['currentTime']);
    }else{
